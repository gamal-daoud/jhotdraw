...
public final class Attributes {
  ...
  private final HashMap<AttributeKey<?>, Object> attributesCollection = new HashMap<>();

  /**
   * Forbidden attributes can't be put by the put() operation. They can only be
   * changed by put().
   */
  ...
  /*
   * Creates a new instance of Attributes with no listener and no dependent
   * supplier.
   */
  public Attributes() {
    this(null, null);
  ...
  /*
   * Creates a new instance of Attributes with the specified listener and
   * dependent supplier.
   *
   * @param listener The attribute listener.
   *
  ...
  /*
   * Sets the supplier for dependent attributes. Dependent attributes are
   * attributes of other
   * figures that should be changed when an attribute of this figure is changed.
   *
   * @param dependent The supplier for dependent attributes. If null, no dependent
  ...
  /*
   * Enables or disables an attribute for this figure to be processed. If an
   * attribute is disabled,
   * it can't be set on this figure and won't be included in the attributes of
   * this figure.
   *
  ...
  /**
   * Copy attribute values from a map of attribute values. This detects also the
   * use of
   * UserData sub maps and copy only those values and creates a new instance of
   * UserData itself.
   *
   * @param map
   */
  ...
  public Map<AttributeKey<?>, Object> getAttributes() {
    return Collections.unmodifiableMap(attributesCollection);
  }

  /**
   * Gets data which can be used to restore the attributes of the figure after a
   * set has been
   * applied to it.
   */
  public Object getAttributesRestoreData() {
    List<Attributes> dependentList = this.dependent.get();
    if (dependentList.isEmpty()) {
      return new HashMap<>(attributesCollection);
    } else {
      List<Map<AttributeKey<?>, Object>> list = new ArrayList<>();
      list.add(new HashMap<>(attributesCollection));
      for (Attributes attr : dependentList) {
  ...
  /**
   * Sets an attribute on the figure and calls {@code attributeChanged} on all
   * registered {@code
   * FigureListener}s if the attribute value has changed.
   *
   * <p>
   * For efficiency reasons, the drawing is not automatically repainted. If you
   * want the drawing
   * to be repainted when the attribute is changed, you can either use
   * {@code key.set(figure,
   * value); } or
   *
   * <pre>
   ...
   * @return Returns the attribute value. If the Figure does not have an attribute
   *         with the
  ...
  /**
   * Gets an attribute from the Figure. Includes this attribute, if it was not
   * there.
   *
   * @see AttributeKey#get
   * @return Returns the attribute value. If the Figure does not have an attribute
  ...
  public <T> T getAndInclude(AttributeKey<T> key) {
    return key.getAndInclude(attributesCollection);
  }

  /*
   * Removes an attribute from the figure and calls {@code attributeChanged} on
   * all registered
  ...
  /*
   * Creates a new instance of Attributes by copying the attributes from the
   * source Attributes.
   * The listener and dependent supplier are set to null.
   *
   * @param source The source Attributes to copy from.
   *
   * @return A new instance of Attributes with the copied attributes and no
   * listener or dependent supplier.
   */
   ...
   * Creates a new instance of Attributes by copying the attributes from the
   * source Attributes
   * and using the specified listener. The dependent supplier is set to null.
   *
   * @param source The source Attributes to copy from.
   *
   * @param listener The attribute listener for the new Attributes. If null, no
   * listener will be used.
   *
   * @return A new instance of Attributes with the copied attributes and specified
   * listener.
   */
   ...
   * Creates a new instance of Attributes by copying the attributes from the
   * source Attributes
   * and using the specified listener and dependent supplier.
   *
   * @param source The source Attributes to copy from.
   *
   * @param listener The attribute listener for the new Attributes. If null, no
   * listener will be used.
   *
   * @param dependent The supplier for dependent attributes for the new
   * Attributes. If null, no dependent attributes will be used.
   *
   * @return A new instance of Attributes with the copied attributes and specified
   * listener and dependent supplier.
   */
  ...
  /*
   * Creates a supplier for the attributes of a list of figures.
   *
   * @param dependent The supplier for the list of figures. If null, an empty list
   * will be used.
   *
  ...
  /*
   * The AttributeListener interface defines a listener for attribute changes.
   *
